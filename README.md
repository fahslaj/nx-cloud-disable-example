...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/yGCX4KEJUV)
...
```sh
npx nx serve nx-cloud-disable-example
```

To create a production bundle:

```sh
npx nx build nx-cloud-disable-example
```

To see all available targets to run for a project, run:

```sh
npx nx show project nx-cloud-disable-example
```
